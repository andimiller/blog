...
cs launch org.scalameta:mdoc_2.13:2.3.7 -- --classpath $CATS_CORE_213:$SCODEC_CORE_213:$SQUANTS_213 --in ./mdoc-posts/2023-03-28-count-distinct-at-scale-I.md --out ./posts/ #/2023-03-28-count-distinct-at-scale-I.md
