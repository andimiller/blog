...
CATS_LAWS_213=$(cs fetch -p org.typelevel:cats-laws_2.13:2.9.0)
...
cs launch org.scalameta:mdoc_2.13:2.3.7 -- --classpath $CATS_CORE_213:$HEDGEHOGS_213:$HEDGEHOGS_CIRCE_213:$FS2_IO_213:$CIRCE_PARSER_213 --in ./mdoc-posts/2023-04-09-conways-game-of-life-3d-graph.md --out ./posts/
cs launch org.scalameta:mdoc_2.13:2.3.7 -- --classpath $CATS_CORE_213:$CATS_LAWS_213 --in ./mdoc-posts/2023-12-02-semigroups-and-distributed-systems.md --out ./posts/
