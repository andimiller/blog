...
Server Admin & Have experience with managing many types of servers, including various Linux and BSD distributions, and Windows Server. Also maintain my own VPS for personal use running Debian.\\
...
%	\begin{packed}
%	\item Acquired good teamwork skills
%	\end{packed}
\end{itemize}
%
