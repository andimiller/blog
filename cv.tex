...
Multithreading & I have experimented with many different threading approaches, and Functional programming languages, including Python's multiprocessing module, and Haskell.\\
...
Version Control & When coding I've used lots of Version Control systems, including SVN, Git and Bazaar.\\
Virtualisation & I maintain a set of Virtual Machines for testing personal projects, and to stay up to date with different Operating Systems with minimal effort.\\
Web Development & Multiple personal sites, making me familiar with XHTML, HTML5, CSS, AJAX and ECMAScript with and without jQuery.\\
\end{tabular}
...
\section*{References}
\begin{tabular}{ r l l }
Capacity & Tutor & GSoC Project Mentor\\
Name & Reyer Zwiggelaar & Michael Sheldon\\
Address & Department of Computer Science & Department of Computer Science\\
& Llandinam Building & Llandinam Building\\
& Aberystwyth University & Aberystwyth University\\
& Aberystwyth & Aberystwyth\\
& Ceredigion & Ceredigion\\
& SY23 3DB & SY23 3DB\\
Email & \href{mailto:rrz@aber.ac.uk}{rzz@aber.ac.uk} & \href{mailto:elleo@gnu.org}{elleo@gnu.org}\\
Telephone & 01970 622219 & 07957 686011\\
\end{tabular}
